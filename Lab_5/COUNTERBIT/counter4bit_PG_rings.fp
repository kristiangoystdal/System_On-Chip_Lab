...
#  Generated on:      Tue Jan  7 12:07:32 2025
#  Design:            counter4bit
#  Command:           saveFPlan counter4bit_PG_rings.fp
###############################################################

Version: 8

Head Box: 0.0000 0.0000 29.2000 26.4000
IO Box: 0.0000 0.0000 29.2000 26.4000
Core Box: 3.6000 3.6000 25.6000 22.8000
UseStdUtil: false
...
##############################################################################
DefRow: CORE_ROW_0 core 3.6000 3.6000 FS 55 1 0.4000 0.0000
DefRow: CORE_ROW_1 core 3.6000 6.8000 N 55 1 0.4000 0.0000
DefRow: CORE_ROW_2 core 3.6000 10.0000 FS 55 1 0.4000 0.0000
DefRow: CORE_ROW_3 core 3.6000 13.2000 N 55 1 0.4000 0.0000
DefRow: CORE_ROW_4 core 3.6000 16.4000 FS 55 1 0.4000 0.0000
DefRow: CORE_ROW_5 core 3.6000 19.6000 N 55 1 0.4000 0.0000

############################################################################################
#  Track: dir start number space layer_num layer1 [firstColor] [isSameColor] [width] [rule]#
############################################################################################
Track: Y 0.8000 32 0.8000 1 8
Track: X 0.8000 36 0.8000 1 8
Track: X 0.2000 73 0.4000 1 7
Track: Y 0.8000 32 0.8000 1 7
Track: Y 0.2000 66 0.4000 1 6
Track: X 0.2000 73 0.4000 1 6
Track: X 0.2000 73 0.4000 1 5
Track: Y 0.2000 66 0.4000 1 5
Track: Y 0.2000 66 0.4000 1 4
Track: X 0.2000 73 0.4000 1 4
Track: X 0.2000 73 0.4000 1 3
Track: Y 0.2000 66 0.4000 1 3
Track: Y 0.2000 66 0.4000 1 2
Track: X 0.2000 73 0.4000 1 2
Track: X 0.2000 73 0.4000 1 1
Track: Y 0.2000 66 0.4000 1 1

######################################################
#  GCellGrid: dir start number space                 #
######################################################
GCellGrid: X 28.2000 2 1.0000
GCellGrid: X 0.2000 8 4.0000
GCellGrid: X 0.0000 2 0.2000
GCellGrid: Y 24.2000 2 2.2000
GCellGrid: Y 0.2000 7 4.0000
...
<HierarchicalPartitions>
    ...
    <Partition name="counter4bit" hinst="" coreToLeft=0.0000 coreToRight=0.0000 coreToTop=0.0000 coreToBottom=0.0000 pinSpacingNorth=-1 pinSpacingWest=-1 pinSpacingSouth=-1 pinSpacingEast=-1 blockedLayers=0xff orient=R0>
...
#  SprFile: <file_name>                                         #
#################################################################
SprFile: counter4bit_PG_rings.fp.spr
...
<IOPins>
  <Pin name="clk" status="placed" >
    <Port>
      <Pref x=15.0000 y=0.0000 side=S width=0.2000 depth=0.5200 />
      <Layer id=2 >
        <Box llx=14.9000 lly=0.0000 urx=15.1000 ury=0.5200 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="enable" status="placed" >
    <Port>
      <Pref x=0.0000 y=13.0000 side=W width=0.2000 depth=0.5200 orientation=R270 />
      <Layer id=3 >
        <Box llx=0.0000 lly=12.9000 urx=0.5200 ury=13.1000 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="count_dir" status="placed" >
    <Port>
      <Pref x=0.0000 y=12.6000 side=W width=0.2000 depth=0.5200 orientation=R270 />
      <Layer id=3 >
        <Box llx=0.0000 lly=12.5000 urx=0.5200 ury=12.7000 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="reset" status="placed" >
    <Port>
      <Pref x=0.0000 y=13.4000 side=W width=0.2000 depth=0.5200 orientation=R270 />
      <Layer id=3 >
        <Box llx=0.0000 lly=13.3000 urx=0.5200 ury=13.5000 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="count[3]" status="placed" >
    <Port>
      <Pref x=29.2000 y=13.0000 side=E width=0.2000 depth=0.5200 orientation=R90 />
      <Layer id=3 >
        <Box llx=28.6800 lly=12.9000 urx=29.2000 ury=13.1000 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="count[2]" status="placed" >
    <Port>
      <Pref x=29.2000 y=13.4000 side=E width=0.2000 depth=0.5200 orientation=R90 />
      <Layer id=3 >
        <Box llx=28.6800 lly=13.3000 urx=29.2000 ury=13.5000 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="count[1]" status="placed" >
    <Port>
      <Pref x=29.2000 y=13.8000 side=E width=0.2000 depth=0.5200 orientation=R90 />
      <Layer id=3 >
        <Box llx=28.6800 lly=13.7000 urx=29.2000 ury=13.9000 />
      </Layer>
    </Port>
  </Pin>
  <Pin name="count[0]" status="placed" >
    <Port>
      <Pref x=29.2000 y=14.2000 side=E width=0.2000 depth=0.5200 orientation=R90 />
      <Layer id=3 >
        <Box llx=28.6800 lly=14.1000 urx=29.2000 ury=14.3000 />
      </Layer>
    </Port>
  </Pin>
</IOPins>
