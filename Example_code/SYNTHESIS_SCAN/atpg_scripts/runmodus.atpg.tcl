...
#-------------------------------------------------------------------------------
build_model \
    -cell	 counter4bit_scan \
    -techlib	 ../../SIMULATION/verilog_libs/fsc0h_d_generic_core_21.lib.src \
    -designsource	 $WORKDIR/counter4bit_scan.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/counter4bit_scan.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
#-------------------------------------------------------------------------------
create_logic_tests \
    -experiment	 counter4bit_scan_atpg \
    -testmode	 FULLSCAN \

check_log log_create_logic_tests_FULLSCAN_counter4bit_scan_atpg
...
#-------------------------------------------------------------------------------
write_vectors \
    -inexperiment	 counter4bit_scan_atpg \
    -testmode	 FULLSCAN \
    -language	 verilog \
    -scanformat	 parallel \

check_log log_write_vectors_FULLSCAN_counter4bit_scan_atpg
...
check_log log_commit_tests_FULLSCAN_counter4bit_scan_atpg
