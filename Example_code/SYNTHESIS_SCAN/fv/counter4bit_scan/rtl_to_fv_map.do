...
# Generated on: Fri Dec 06 10:25:12 WET 2024 (Fri Dec 06 10:25:12 UTC 2024)
...
set_log_file fv/counter4bit_scan/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/counter4bit_scan -revised fv_map
...
add_search_path ~/DIGITAL/SIMULATION/COUNTER4BIT/src -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  counter4bit_scan.v
elaborate_design -golden -root {counter4bit_scan} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/counter4bit_scan/fv_map.v.gz
elaborate_design -revised -root {counter4bit_scan}
...
#add_name_alias fv/counter4bit_scan/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/counter4bit_scan/rtl_to_fv_map.log
}
