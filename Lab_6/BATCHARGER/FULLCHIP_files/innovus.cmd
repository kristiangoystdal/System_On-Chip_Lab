...
#  Created on Thu Jan 16 20:24:48 2025                
#                                                     
#######################################################
...
init_design
floorPlan -site core_2800 -d 1250.0 800.0 6.0 6.0 6.0 6.0
...
globalNetConnect pgnd -type tielo -instanceBasename *
addIoFiller -cell EMPTY8HB
addIoFiller -cell EMPTY4HB
addIoFiller -cell EMPTY2HB
addIoFiller -cell EMPTY1HB
globalNetConnect pgnd -type pgpin -pin GND -instanceBasename * -hierarchicalInstance {}
...
setAttribute -net iforcedbat -shield_net pgnd
selectNet -shield
routeDesign -selected
routeDesign -globalDetail
saveIoFile -locations FULLCHIP.save.io
